...
export async function cmdChain(cwd, { flags, text }) {
  ...
  // `flags.container` rather than the validated `container` below: the
  // missing-container error keeps its current position, and with no container
  // there is nothing to run the baseline in.
  if (flags.container) {
