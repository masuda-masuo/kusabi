...
- kaiba is read-only for you: recall what earlier phases concluded, but you cannot file anything. A durable fact you turn up during the review belongs in your review output — the orchestrator decides what gets stored.
