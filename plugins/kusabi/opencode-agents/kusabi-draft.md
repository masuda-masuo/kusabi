...
- kaiba is read-only for you: recall what earlier phases concluded, but you cannot file anything. A durable fact you turn up while searching goes in your final report — the orchestrator decides what gets stored.
