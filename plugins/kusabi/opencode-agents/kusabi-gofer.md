...
9. **kaiba**: `kaiba_recall` lets you look up what earlier phases concluded, and `kaiba_progress` lets you record in-flight notes. `kaiba_remember` is not allowed — a durable fact you turn up goes in your final report for the orchestrator to file.
