...
- kaiba is read-only for you: recall what earlier phases concluded, but you cannot file anything. A durable fact you turn up during the investigation goes in your final report — the orchestrator decides what gets stored.
